...
class TranslationService:
    """
    Gemini API를 사용한 번역 + 한국어 문화적 뉘앙스 감지 서비스
    ...
    def __init__(self):
        ...
        if gemini_key:
            try:
                ...
                - DO NOT translate literally. If a Korean expression is slang or an idiom (e.g., '자살각', '먼지 같다'), translate it into a natural English equivalent (e.g., 'I'm so done', 'It's no big deal').
                - Maintain the tone: If the source is casual/slang, the translation should be casual/slang.
                - Handle profanity naturally: Translate Korean swear words (ㅅㅂ, 존나) into appropriate English equivalents (damn, freaking, etc.) rather than ignoring them.
